...
})({"lPZpN":[function(require,module,exports,__globalThis) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = 63185;
var HMR_SERVER_PORT = 63185;
var HMR_SECURE = false;
var HMR_ENV_HASH = "42036d7a98ade5a7";
var HMR_USE_SSE = false;
module.bundle.HMR_BUNDLE_ID = "e74687e13b12fa51";
"use strict";
...
},{}],"XeI67":[function(require,module,exports,__globalThis) {
var _tweenMaxMinJs = require("../src/js/TweenMax.min.js");
var _cookiesJs = require("../src/js/cookies.js");
var _mainJs = require("../src/js/main.js");
var _prismJs = require("../src/js/prism.js");

},{"../src/js/TweenMax.min.js":"lLlRe","../src/js/cookies.js":"7ykOo","../src/js/main.js":"aKvBm","../src/js/prism.js":"lX5sc"}],"lLlRe":[function(require,module,exports,__globalThis) {
/*!
 * VERSION: 1.18.5
 * DATE: 2016-05-24
 ...
 **/ var global = arguments[3];
var _gsScope = module.exports && "undefined" != typeof global ? global : this || window;
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
    ...
    _gsScope._gsDefine("TweenMax", [
        ...
        f.version = "1.18.5", k.constructor = f, k.kill()._gc = !1, f.killTweensOf = f.killDelayedCallsTo = c.killTweensOf, f.getTweensOf = c.getTweensOf, f.lagSmoothing = c.lagSmoothing, f.ticker = c.ticker, f.render = c.render, k.invalidate = function() {
            ...
            if (a >= n - 1e-7 ? (this._totalTime = n, this._cycle = this._repeat, this._yoyo && 0 !== (1 & this._cycle) ? (this._time = 0, this.ratio = this._ease._calcEnd ? this._ease.getRatio(0) : 0) : (this._time = r, this.ratio = this._ease._calcEnd ? this._ease.getRatio(1) : 1), this._reversed || (d = !0, e = "onComplete", c = c || this._timeline.autoRemoveChildren), 0 === r && (this._initted || !this.vars.lazy || c) && (this._startTime === this._timeline._duration && (a = 0), (0 > s || 0 >= a && a >= -0.0000001 || s === g && "isPause" !== this.data) && s !== a && (c = !0, s > g && (e = "onReverseComplete")), this._rawPrevTime = m = !b || a || s === a ? a : g)) : 1e-7 > a ? (this._totalTime = this._time = this._cycle = 0, this.ratio = this._ease._calcEnd ? this._ease.getRatio(0) : 0, (0 !== p || 0 === r && s > 0) && (e = "onReverseComplete", d = this._reversed), 0 > a && (this._active = !1, 0 === r && (this._initted || !this.vars.lazy || c) && (s >= 0 && (c = !0), this._rawPrevTime = m = !b || a || s === a ? a : g)), this._initted || (c = !0)) : (this._totalTime = this._time = a, 0 !== this._repeat && (i = r + this._repeatDelay, this._cycle = this._totalTime / i >> 0, 0 !== this._cycle && this._cycle === this._totalTime / i && a >= p && this._cycle--, this._time = this._totalTime - this._cycle * i, this._yoyo && 0 !== (1 & this._cycle) && (this._time = r - this._time), this._time > r ? this._time = r : this._time < 0 && (this._time = 0)), this._easeType ? (j = this._time / r, k = this._easeType, l = this._easePower, (1 === k || 3 === k && j >= .5) && (j = 1 - j), 3 === k && (j *= 2), 1 === l ? j *= j : 2 === l ? j *= j * j : 3 === l ? j *= j * j * j : 4 === l && (j *= j * j * j * j), 1 === k ? this.ratio = 1 - j : 2 === k ? this.ratio = j : this._time / r < .5 ? this.ratio = j / 2 : this.ratio = 1 - j / 2) : this.ratio = this._ease.getRatio(this._time / r)), o === this._time && !c && q === this._cycle) return void (p !== this._totalTime && this._onUpdate && (b || this._callback("onUpdate")));
            if (!this._initted) {
                if (this._init(), !this._initted || this._gc) return;
                if (!c && this._firstPT && (this.vars.lazy !== !1 && this._duration || this.vars.lazy && !this._duration)) return this._time = o, this._totalTime = p, this._rawPrevTime = s, this._cycle = q, h.lazyTweens.push(this), void (this._lazy = [
                    a,
                    b
                ]);
        ...
        return d.version = "1.18.5", q.constructor = d, q.kill()._gc = q._forcingPlayhead = q._hasPause = !1, q.to = function(a, b, d, e) {
            ...
            if (a >= n - 1e-7) this._totalTime = this._time = n, this._reversed || this._hasPausedChild() || (f = !0, h = "onComplete", i = !!this._timeline.autoRemoveChildren, 0 === this._duration && (0 >= a && a >= -0.0000001 || this._rawPrevTime < 0 || this._rawPrevTime === e) && this._rawPrevTime !== a && this._first && (i = !0, this._rawPrevTime > e && (h = "onReverseComplete"))), this._rawPrevTime = this._duration || !b || a || this._rawPrevTime === a ? a : e, a = n + 1e-4;
            else if (1e-7 > a) {
        ...
        return j.constructor = d, j.kill()._gc = !1, d.version = "1.18.5", j.invalidate = function() {
            ...
            if (a >= o - 1e-7) this._locked || (this._totalTime = o, this._cycle = this._repeat), this._reversed || this._hasPausedChild() || (f = !0, j = "onComplete", k = !!this._timeline.autoRemoveChildren, 0 === this._duration && (0 >= a && a >= -0.0000001 || 0 > u || u === e) && u !== a && this._first && (k = !0, u > e && (j = "onReverseComplete"))), this._rawPrevTime = this._duration || !b || a || this._rawPrevTime === a ? a : e, this._yoyo && 0 !== (1 & this._cycle) ? this._time = a = 0 : (this._time = p, a = p + 1e-4);
            else if (1e-7 > a) {
            ...
            if (this._cycle !== w && !this._locked) {
                ...
                if (y && (q = x ? p + 1e-4 : -0.0001, this.render(q, !0, !1)), this._locked = !1, this._paused && !v) return;
        ...
        var k, l, m, n, o, p, q = /(?:\-|\.|\b)(\d|\.|e\-)+/g, r = /(?:\d|\-\d|\.\d|\-\.\d|\+=\d|\-=\d|\+=.\d|\-=\.\d)+/g, s = /(?:\+=|\-=|\-|\b)[\d\-\.]+[a-zA-Z0-9]*(?:%|\b)/gi, t = /(?![+-]?\d*\.?\d+|[+-]|e[+-]\d+)[^0-9]/g, u = /(?:\d|\-|\+|=|#|\.)*/g, v = /opacity *= *([^)]*)/i, w = /opacity:([^;]*)/i, x = /alpha\(opacity *=.+?\)/i, y = /^(rgb|hsl)/, z = /([A-Z])/g, A = /-([a-z])/gi, B = /(^(?:url\(\"|url\())|(?:(\"\))$|\)$)/gi, C = function(a, b) {
        ...
        }, X = L.defaultView ? L.defaultView.getComputedStyle : function() {}, Y = g.getStyle = function(a, b, c, d, e) {
            var f;
            ...
            var c, d, e, f = {};
            if (b = b || X(a, null)) {
                if (c = b.length) for(; --c > -1;)e = b[c], (-1 === e.indexOf("-transform") || Aa === e) && (f[e.replace(A, C)] = b.getPropertyValue(e));
                else for(c in b)(-1 === c.indexOf("Transform") || za === c) && (f[c] = b[c]);
        ...
        var na = function(a, b, c, d) {
            ...
            var e, f = b ? (a.match(ma) || [
                ""
            ])[0] : "", g = a.split(f).join("").match(s) || [], h = a.substr(0, a.indexOf(g[0])), i = ")" === a.charAt(a.length - 1) ? ")" : "", j = -1 !== a.indexOf(" ") ? " " : ",", k = g.length, l = k > 0 ? g[0].replace(q, "") : "";
            return k ? e = b ? function(a) {
                ...
                if (b = (a.match(ma) || [
                    f
                ])[0], m = a.split(b).join("").match(s) || [], n = m.length, k > n--) for(; ++n < k;)m[n] = c ? m[(n - 1) / 2 | 0] : g[n];
            ...
            c = c || f || "", h = new qa(a, b, 0, 0, h, l ? 2 : 1, null, !1, i, c, d), d += "", e && ma.test(d + c) && (d = [
                c,
                d
            ...
            for((-1 !== d.indexOf(",") || -1 !== c.indexOf(",")) && (B = B.join(" ").replace(G, ", ").split(" "), C = C.join(" ").replace(G, ", ").split(" "), D = B.length), D !== C.length && (B = (f || "").split(" "), D = B.length), h.plugin = j, h.setRatio = l, ma.lastIndex = 0, m = 0; D > m; m++)if (p = B[m], s = C[m], v = parseFloat(p), v || 0 === v) h.appendXtra("", v, fa(s, v), s.replace(r, ""), E && -1 !== s.indexOf("px"), !0);
        ...
        var ua = function(a, b) {
            ...
            for(c = c || [
                g
            ], d = 0; d < f.length; d++)b.prefix = 0 === d && b.prefix, b.defaultValue = c[d] || g, e = new ua(f[d], b);
        }, wa = function(a) {
            if (!i[a]) {
        ...
        j = ua.prototype, j.parseComplex = function(a, b, c, d, e, f) {
            ...
            if (this.multi && (G.test(c) || G.test(b) ? (h = b.replace(G, "|").split("|"), i = c.replace(G, "|").split("|")) : m && (h = [
                b
            ], i = [
                c
            ])), i) {
        ...
        var xa, ya = "scaleX,scaleY,scaleZ,x,y,z,skewX,skewY,rotation,rotationX,rotationY,perspective,xPercent,yPercent".split(","), za = W("transform"), Aa = U + "transform", Ba = W("transformOrigin"), Ca = null !== W("perspective"), Da = P.Transform = function() {
            ...
            v && (t = v.xOrigin, u = v.yOrigin), (!d || (h = d.split(" ")).length < 2) && (n = a.getBBox(), b = ea(b).split(" "), h = [
            ...
            if (za ? d = Y(a, Aa, null, !0) : a.currentStyle && (d = a.currentStyle.filter.match(E), d = d && 4 === d.length ? [
                d[0].substr(4),
                Number(d[2].substr(4)),
                Number(d[1].substr(4)),
                d[3].substr(4),
            ...
            for(e = (d || "").match(q) || [], ta = e.length; --ta > -1;)f = Number(e[ta]), e[ta] = (g = f - (f |= 0)) ? (g * j + (0 > g ? -0.5 : .5) | 0) / j + f : f;
            return b && e.length > 6 ? [
                e[0],
                e[1],
                e[4],
        ...
        j = Da.prototype, j.x = j.y = j.z = j.skewX = j.skewY = j.rotation = j.rotationX = j.rotationY = j.zOrigin = j.xPercent = j.yPercent = j.xOffset = j.yOffset = 0, j.scaleX = j.scaleY = j.scaleZ = 1, va("transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,svgOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent,smoothOrigin", {
            ...
            formatter: function(a) {
                var b = a.split(" ");
                return b[0] + " " + (b[1] || "solid") + " " + (a.match(ma) || [
                    "#000"
                ])[0];
            }
        }), va("borderWidth", {
        ...
        var Ta = function(a) {
            if ((1 === a || 0 === a) && this.data._totalTime === this.data._totalDuration && "isFromStart" !== this.data.data) {
                ...
                else for(b = this.e.split(" ").join("").split(","), d = b.length; --d > -1;)c = b[d], i[c] && (i[c].parse === h ? e = !0 : c = "transformOrigin" === c ? Ba : i[c].p), Ra(g, c);
        ...
        var Va = function(a, b, c) {
            ...
            else for(d = a.childNodes, e = d.length; --e > -1;)f = d[e], g = f.type, f.style && (b.push(_(f)), c && c.push(f)), 1 !== g && 9 !== g && 11 !== g || !f.childNodes.length || Va(f, b, c);
        };
    ...
    if (!d.TweenLite) {
            ...
            this.check = function(k) {
                ...
                if (0 === t && g) {
                    if (m = ("com.greensock." + e).split("."), n = m.pop(), o = j(m.join("."))[n] = this.gsClass = g.apply(g, i), h) {
                        if (d[n] = o, r = module.exports, !r && "function" == typeof define && define.amd) define((a.GreenSockAMDPath ? a.GreenSockAMDPath + "/" : "") + e.split(".").pop(), [], function() {
                            return o;
                        });
                        else if (r) {
                            if (e === b) {
        ...
        var t = [
            ...
            1,
            1
        ], u = [], v = s("easing.Ease", function(a, b, c, d) {
        ...
        for(g = v.prototype, g._calcEnd = !1, g.getRatio = function(a) {
            ...
            "Quart",
            "Quint,Strong"
        ], f = e.length; --f > -1;)g = e[f] + ",Power" + f, x(new v(null, null, 1, f), g, "easeOut", !0), x(new v(null, null, 2, f), g, "easeIn" + (0 === f ? ",easeNone" : "")), x(new v(null, null, 3, f), g, "easeInOut");
        ...
        for(e = [
            ...
            "webkit",
            "o"
        ], f = e.length; --f > -1 && !z;)z = a[e[f] + "RequestAnimationFrame"], A = a[e[f] + "CancelAnimationFrame"] || a[e[f] + "CancelRequestAnimationFrame"];
        ...
        g._init = function() {
            ...
            for(f in this.vars)if (k = this.vars[f], T[f]) k && (k instanceof Array || k.push && o(k)) && -1 !== k.join("").indexOf("{self}") && (this.vars[f] = k = this._swapSelfInParams(k, this));
            ...
            if (a >= i - 1e-7) this._totalTime = this._time = i, this.ratio = this._ease._calcEnd ? this._ease.getRatio(1) : 1, this._reversed || (d = !0, e = "onComplete", c = c || this._timeline.autoRemoveChildren), 0 === i && (this._initted || !this.vars.lazy || c) && (this._startTime === this._timeline._duration && (a = 0), (0 > j || 0 >= a && a >= -0.0000001 || j === l && "isPause" !== this.data) && j !== a && (c = !0, j > l && (e = "onReverseComplete")), this._rawPrevTime = g = !b || a || j === a ? a : l);
            ...
            if (this._time !== h || c) {
                ...
                this._onUpdate && (0 > a && this._startAt && a !== -0.0001 && this._startAt.render(a, b, c), b || (this._time !== h || d || c) && this._callback("onUpdate")), e && (!this._gc || c) && (0 > a && this._startAt && !this._onUpdate && a !== -0.0001 && this._startAt.render(a, b, c), d && (this._timeline.autoRemoveChildren && this._enabled(!1, !1), this._active = !1), !b && this.vars[e] && this._callback(e), 0 === i && this._rawPrevTime === l && g !== l && (this._rawPrevTime = 0));
            }
        }, g._kill = function(a, b, c) {
            if ("all" === a && (a = null), null == a && (null == b || b === this.target)) return this._lazy = !1, this._enabled(!1, !1);
            b = "string" != typeof b ? b || this._targets || this.target : G.selector(b) || b;
            var d, e, f, g, h, i, j, k, l, m = c && this._time && c._startTime === this._startTime && this._timeline === c._timeline;
            if ((o(b) || H(b)) && "number" != typeof b[0]) for(d = b.length; --d > -1;)this._kill(a, b[d], c) && (i = !0);
            else {
                if (this._targets) {
        ...
        if (g = ba.prototype, ba.version = "1.18.0", ba.API = 2, g._firstPT = null, g._addTween = O, g.setRatio = M, g._kill = function(a) {
            ...
            return g.version = a.version, ba.activate([
                g
            ]), g;
        }, e = a._gsQueue) {
...
},{}],"7ykOo":[function(require,module,exports,__globalThis) {
/*\
|*|
|*|  :: cookies.js ::
|*|
...
},{}],"aKvBm":[function(require,module,exports,__globalThis) {
// Vanilla JS DOMContentLoaded
document.addEventListener('DOMContentLoaded', function() {
    function doOnce() {
        var isReduced = window.matchMedia('(prefers-reduced-motion: reduce)').matches === true;
        if (!document.body.classList.contains("brdr-black") && !isReduced) intro();
        if (isReduced) document.body.classList.remove("brdr-black");
        if (document.body.classList.contains("contact-go")) goContact();
    }
    doOnce();
    ...
    function intro() {
        ...
        if (shapeContainer) shapeContainer.style.height = t + 'px';
        ...
        }).to(document.getElementById('container'), 2, {
            css: {
                className: '+=dark'
            }
        }).to(document.body, 0, {
        ...
        }).to(document.getElementById('container'), 0, {
            css: {
                className: '+=out'
            }
        }).to(document.getElementById('cookies'), 0, {
            delay: 3,
            css: {
                className: '+=show'
            }
    ...
    document.querySelectorAll('input.floatlabel, textarea.floatlabel').forEach(function(el) {
        ...
        el.addEventListener('blur', function() {
            ...
            var label = el.parentElement.querySelector('.contact_label');
            if (label) {
                if (inputContent !== '') label.classList.add('has-content');
                else label.classList.remove('has-content');
                label.classList.remove('active');
            }
        });
    });
    var contactForm = document.getElementById('contact-form');
    if (contactForm) // You need to replace jQuery validate with a vanilla JS validation or use a library
    contactForm.addEventListener('submit', function(e) {
        ...
        if (valid) {
            ...
            xhr.onload = function() {
                if (xhr.status >= 200 && xhr.status < 300) window.location = '/thankyou.html';
                else alert('Sorry, there was an error while submitting your details. Please try again later');
            };
    ...
    if (navMain && navWrap) {
        ...
        var observer = new IntersectionObserver(function(entries) {
            entries.forEach(function(entry) {
                if (!entry.isIntersecting) navWrap.classList.add('nav-up');
                else navWrap.classList.remove('nav-up');
            });
        }, {
            threshold: 0
        });
...
},{}],"lX5sc":[function(require,module,exports,__globalThis) {
/* PrismJS 1.23.0
https://prismjs.com/download.html#themes=prism-dark&languages=markup+css+clike+javascript+bash+jsx+tsx+scss+typescript&plugins=command-line+toolbar+copy-to-clipboard */ var global = arguments[3];
...
!function() {
    if ("undefined" != typeof Prism && "undefined" != typeof document) {
        var p = /(?:^|\s)command-line(?:\s|$)/, d = "command-line-prompt", m = "".startsWith ? function(e, t) {
        ...
        Prism.hooks.add("before-highlight", function(e) {
            ...
            if (!t.complete && e.code) {
                ...
                if (n && /pre/i.test(n.nodeName) && (p.test(n.className) || p.test(e.element.className))) {
            ...
            if (!t.complete) {
                ...
                p.test(e.element.className) && (e.element.className = e.element.className.replace(p, " ")), p.test(a.className) || (a.className += " command-line");
                var r = t.numberOfLines || 0, s = c("data-prompt", "");
                if ("" !== s) n = f('<span data-prompt="' + s + '"></span>', r);
                else n = f('<span data-user="' + c("data-user", "user") + '" data-host="' + c("data-host", "localhost") + '"></span>', r);
...
},{}]},["lPZpN","XeI67"], "XeI67", "parcelRequire0a9c", {})
